...
public class AdapterItemOrder extends RecyclerView.Adapter<AdapterItemOrder.Holder_detals> {
    Context context;
    List<ModelCart> list;
    AdapterItemOrder.OnItemClickListner listener;
    ...
    public void setOnItemClickListner(AdapterItemOrder.OnItemClickListner listener){
        this.listener=listener;

    }

    public AdapterItemOrder(Context context, List list){
    ...
    @NonNull
    @Override
    public AdapterItemOrder.Holder_detals onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(context).inflate(R.layout.item_cart,parent,false);

        return new AdapterItemOrder.Holder_detals(v,listener);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterItemOrder.Holder_detals holder, int position) {
    ...
    public class Holder_detals extends RecyclerView.ViewHolder {
        ...
        ImageView imageView;
        public Holder_detals(@NonNull View itemView, AdapterItemOrder.OnItemClickListner listener) {
            super(itemView);
